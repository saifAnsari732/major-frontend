...
const Btech_branch = () => {
  ...
  const branches = [
    {
      ...
      color: '#2563EB',
      icon: '💻',
      link: '/cs-papers' // Add link for each branch
    },
    {
      id: 2,
  ...
  const handleCardHeaderClick = (branch) => {
    navigate(branch.link);
  };
            ...
            {branches.map((branch) => {
              return (
                ...
                >
                  ...
                  <div 
                    className="branch-card-header clickable-header"
                    onClick={() => handleCardHeaderClick(branch)}
